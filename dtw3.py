...
import csv
with open("/Users/shibusawasatoshi/Downloads/DTW%2.csv",newline='',encoding='utf-8-sig') as f:
  for row in csv.reader(f):
    print(f"{row}")
with open("/Users/shibusawasatoshi/Downloads/DTW%.csv",newline='',encoding='utf-8-sig') as f:
...
plt.legend()
plt.title('angular velocity in z-coordinate')
plt.show()