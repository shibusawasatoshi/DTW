...
import csv
with open("/Users/shibusawasatoshi/Downloads/DTW2.csv",newline='',encoding='utf-8-sig') as f:
  for row in csv.reader(f):
    print(f"{row}")
with open("/Users/shibusawasatoshi/Downloads/DTW1.csv",newline='',encoding='utf-8-sig') as f:
...
plt.legend()
plt.title('angular velocity in x-coordinate')
plt.show()
